...
//        objectMapper.enableDefaultTyping();
        ...
        customSerializers.addSerializer(PathSegment.class, new IPathSegmentSerializer());
        customSerializers.addDeserializer(PathSegment.class, new IPathSegmentDeserializer());
