...
//
//
//    assertEquals(50.0, stopwatch.pop().seconds, 15.0)
//  }
//
//  @Test
//  fun testFastClockScheduling() {
//
//    val expectedNums = listOf<Number>(1000, 2000, 3000, 4000, 5000)
//
//    val nums = ArrayList<Number>()
//    val clock = TimeWarpedClock(10.0, -70.ms) // -70 because my laptop usually takes 70ms
//
//    // schedule tasks to run at 1000 ms, 2000 ms, 3000 ms, 4000 ms, 5000 ms
//    for (i in 1..5) {
//      clock((i * 1000).toLong(), TimeUnit.MILLISECONDS) { nums.add(clock.time.seconds) }
//    }
//
//    try {
