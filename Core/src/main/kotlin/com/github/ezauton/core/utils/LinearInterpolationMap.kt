 ...
 * @author ritikmishra
 */
open class LinearInterpolationMap private constructor(private val sortedMap: TreeMap<Double, Double>) : Integrable, Serializable,
  InterpolationMap //TODO: Remove redundant methods defined in HashMap, also maybe extends HashMap<Double, Double>?
{
  ...
  override fun integrate(a: Double, b: Double): Double {
    ...
    if (dataPoints.size == 1) {
      lines.add(
        MathUtils.Geometry.LineR2(
          ScalarVector(a.toFloat(), get(a).toFloat()),
      ...
      for (i in 1 until dataPoints.size) {
        ...
        if (x1 < b && x2 > a) {
          ...
          lines.add(
            MathUtils.Geometry.LineR2(
              ScalarVector(x1.toFloat(), get(x1)),
