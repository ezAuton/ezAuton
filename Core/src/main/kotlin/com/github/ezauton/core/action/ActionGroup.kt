...
private class ActionGroupImpl : ActionGroup {
   ...
   */
  private constructor(vararg scheduledActions: ActionWrapper) {
   ...
   * @return this
   */
  override fun addSequential(action: Action): ActionGroup {
   ...
   * @return this
   */
  override fun addSequential(block: ActionFunc): ActionGroup {
   ...
   * @return this
   */
  override fun with(action: Action): ActionGroup {
   ...
   * @return this
   */
  override fun with(block: ActionFunc): ActionGroup {
   ...
   * @return this
   */
  override fun addParallel(action: Action): ActionGroup {
   ...
   * @return this
   */
  override fun addParallel(block: ActionFunc): ActionGroup {
    this.scheduledActions.add(ActionWrapper(block.toAction(), Type.PARALLEL))
    return this
  }

  suspend fun ActionContext.run() = coroutineScope {
