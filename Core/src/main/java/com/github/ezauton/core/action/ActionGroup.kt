...
class ActionGroup : BaseAction {
     ...
     * @return this
     */
    fun addSequential(runnable: Runnable): ActionGroup {
        this.scheduledActions.add(ActionWrapper(BaseAction(runnable), Type.SEQUENTIAL))
        return this
    }
     ...
     * @return this
     */
    fun with(runnable: Runnable): ActionGroup {
        this.scheduledActions.add(ActionWrapper(BaseAction(runnable), Type.WITH))
        return this
    }
     ...
     * @return this
     */
    fun addParallel(runnable: Runnable): ActionGroup {
        this.scheduledActions.add(ActionWrapper(BaseAction(runnable), Type.PARALLEL))
        return this
    }
